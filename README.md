## API Test in Python for a tech poc 
...
- Under the root directory, create an .env file
...
**Beware**: The current default uses the real API but this will speed up your use of your credits. Instead, if you need to work on the data listed by the main API, use the mock to save the $£$!
